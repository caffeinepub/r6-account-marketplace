  ...
  const handleClaimAdmin = async () => {
    ...
    try {
      ...
      if (
        ...
        setClaimError(
          "Admin has already been claimed by another principal. Access denied.",
        );
      } else {
      ...
      return (
        <div className="min-h-screen bg-background flex items-center justify-center">
          <div className="text-center space-y-6 p-8 max-w-md">
            ...
            <p className="text-muted-foreground">
              No admin has been set yet. As the first authenticated user, you
              can claim the admin role permanently.
            </p>
            {claimError && (

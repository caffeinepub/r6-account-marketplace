...
export default function PurchaseFlowModal({
  ...
  const [_credentialBlob, setCredentialBlob] = useState<Uint8Array | null>(
    null,
  );
          ...
          <div className="space-y-4 mt-2">
            <div className="p-4 bg-surface-raised border border-border rounded-sm flex items-start gap-3">
              ...
              <p className="text-sm text-muted-foreground">
                Internet Identity login is required to securely link your
                purchase to your account and deliver credentials.
              </p>
            </div>
            <Button
              onClick={login}

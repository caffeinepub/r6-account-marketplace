...
export default function PaymentStep({
  ...
  const isVerifying =
    verifyIcp.isPending || verifyBtc.isPending || verifyEth.isPending;
    ...
    <div className="space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <div className="flex items-center justify-between p-2 bg-surface border border-gold/20 rounded-sm">
                ...
                <button
                  ...
                  onClick={() =>
                    copyToClipboard(
                      paymentMethod === "btc" ? btcAmount : ethAmount,
                      "amount",
                    )
                  }
                  className="text-muted-foreground hover:text-gold transition-colors"
      ...
      <Alert className="border-gold/20 bg-gold/5">
        ...
        <AlertDescription className="text-sm text-muted-foreground">
          Payment is verified on-chain. Credentials unlock only after
          confirmation.
        </AlertDescription>
      </Alert>
      ...
      <div className="flex gap-3">
        ...
        <Button
          ...
          disabled={
            isVerifying ||
            (paymentMethod === "icp" ? !blockIndex.trim() : !txHash.trim())
          }

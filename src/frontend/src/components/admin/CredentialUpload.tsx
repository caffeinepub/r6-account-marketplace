...
import { AlertTriangle, CheckCircle, Key, Loader2, Upload } from "lucide-react";
    ...
    <div className="space-y-8">
      ...
      <div className="space-y-4">
        ...
        <Alert className="border-yellow-500/30 bg-yellow-500/5">
          ...
          <AlertDescription className="text-sm text-muted-foreground">
            Credentials are stored as-is. Encrypt them before uploading if
        ...
        >
          ...
          <div className="space-y-1.5">
            ...
            <p className="text-xs text-muted-foreground">
              Enter the account credentials. These will be stored and delivered
      ...
      <div className="space-y-4">
        ...
        <Alert className="border-red-500/30 bg-red-500/5">
          ...
          <AlertDescription className="text-sm text-muted-foreground">
            The decryption key is only accessible to admins and is never
            returned to buyers.
          </AlertDescription>
        </Alert>
